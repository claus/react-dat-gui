...
var DatNumber = function (_React$Component) {
    ...
    _createClass(DatNumber, [{
        ...
        value: function getValue() {
            ...
            return this.applyConstraints((0, _lodash.result)(props.data, props.path));
        }
    }, {
        key: 'toNumber',
        ...
        value: function applyConstraints(value) {
            ...
            var hasMin = (0, _lodash.isFinite)(min);
            var hasMax = (0, _lodash.isFinite)(max);
            var hasStep = (0, _lodash.isFinite)(step);
            var isMin = false;
            var isMax = false;
